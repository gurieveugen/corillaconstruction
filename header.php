	...
	<div id="wrapper">
		<header id="header" class="cf">
			...
			<div class="center-wrap">
				...
				<a href="<?php echo home_url('/'); ?>" class="logo" title="<?php echo esc_attr(get_bloginfo('name', 'display')); ?>" rel="home"><img src="<?php echo TDU; ?>/images/logo-construction.png" alt="<?php bloginfo('name'); ?>"></a>
